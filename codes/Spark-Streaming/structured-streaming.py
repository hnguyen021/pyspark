...
accessLines = spark.readStream.text("datasets/logs")
...
# Show the contents of the logsDF
...
#query = (logsDF.writeStream.outputMode("append").format("console").queryName("streaming_logs").start())
